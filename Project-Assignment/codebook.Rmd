...
---
[Link to project on GitHUB](https://github.com/KisooKim/Coursera-Data-Science-3-Getting-and-Cleaning-Data)
...
write.table(tidy_result, file = "peer-review-assignment-project-result.txt",row.name=FALSE)
```